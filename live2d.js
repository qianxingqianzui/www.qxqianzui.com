...
, function(t, i, e) {
    ...
    function n(t) {
        ...
        var r = e / i
          ...
          , _ = -r
          , h = r;
        if (B = new M.L2DViewMatrix,
        B.setScreenRect(o, n, _, h),
        B.setMaxScreenRect(x.default.VIEW_LOGICAL_MAX_LEFT, x.default.VIEW_LOGICAL_MAX_RIGHT, x.default.VIEW_LOGICAL_MAX_BOTTOM, x.default.VIEW_LOGICAL_MAX_TOP),
        B.setMaxScale(x.default.VIEW_MAX_SCALE),
        B.setMinScale(x.default.VIEW_MIN_SCALE),
        U = new M.L2DMatrix44,
        U.multScale(1, i / e),
        G = new M.L2DMatrix44,
    ...
    function u(t) {
        ...
        var i = C.getBoundingClientRect()
          ...
          , n = m(o.x - i.left)
          , s = T(o.y - i.top);
        x.default.DEBUG_MOUSE_LOG && console.log("onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
        k = e,
        V = r,
        N.setPoint(n, s)
    }
    function p(t) {
        ...
        var i = C.getBoundingClientRect()
          ...
          , n = m(o.x - i.left)
          , s = T(o.y - i.top);
        x.default.DEBUG_MOUSE_LOG && console.log("onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
        k = e,
        V = r,
        R.tapEvent(n, s)
    }
    ...
    function d() {
        x.default.DEBUG_LOG && console.log("Set Session Storage."),
    ...
    function g(t) {
        if ("mousewheel" == t.type)
            ...
            x.default.DEBUG_LOG && console.log("Mouse out Window."),
            c();
        ...
        !function() {
            ...
            v._$Vr = function(t, i, e, r, o, n, s, _) {
                ...
                if (a <= 0) {
                    ...
                    for (var A = o[h[0]], I = o[h[1]], w = o[h[2]], O = o[h[3]], D = o[h[4]], R = o[h[5]], b = o[h[6]], F = o[h[7]], g = l[0], P = l[1], C = l[2], y = 1 - g, S = 1 - P, N = 1 - C, B = N * S * y, U = N * S * g, G = N * P * y, Y = N * P * g, k = C * S * y, V = C * S * g, X = C * P * y, z = C * P * g, c = 0; c < $; )
                        n[u] = B * A[c] + U * I[c] + G * w[c] + Y * O[c] + k * D[c] + V * R[c] + X * b[c] + z * F[c],
                        ++c,
            ...
            D.prototype._$Ur = function(t) {
                ...
                for (var i = t._$v2(), e = this._$Ob.length - 1; e >= 0; --e) {
                    ...
                    if (r == w._$ds && (r = t.getParamIndex(this._$Ob[e].getParamID())),
                    t._$Xb(r))
                        return !0
                }
                return !1
            ...
            D.prototype._$Q2 = function(t, i) {
                for (var e, r, o = this._$Ob.length, n = t._$v2(), s = 0, _ = 0; _ < o; _++) {
                    ...
                    e == w._$ds && (e = t.getParamIndex(a.getParamID()),
                    a._$Pb(e, n)),
                    e < 0)
            ...
            V.prototype._$7T = function(t) {
                var i, e = x.getUserTimeMSec(), r = 0;
                switch (this._$_L) {
                case STATE_CLOSING:
                    r = (e - this._$bb) / this._$Dr,
                    r >= 1 && (r = 1,
                    this._$_L = xt.STATE_CLOSED,
                    this._$bb = e),
                    i = 1 - r;
                    break;
                case STATE_CLOSED:
                    r = (e - this._$bb) / this._$Cb,
                    r >= 1 && (this._$_L = xt.STATE_OPENING,
                    this._$bb = e),
                    i = 0;
                    break;
                case STATE_OPENING:
                    ...
                    break;
                case STATE_INTERVAL:
                    this._$12 < e && (this._$_L = xt.STATE_CLOSING,
                    this._$bb = e),
                    i = 1;
                    break;
                case STATE_FIRST:
                        ...
                        if (-2 < v && v < 3 && -2 < L && L < 3)
                            if (v <= 0)
                                if (L <= 0) {
                                    ...
                                    e[T + 1] = N + (F - N) * B + (R - N) * U) : (e[T] = w + (D - w) * (1 - B) + (b - w) * (1 - U),
                ...
                try {
                    ...
                    for (var h = i.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, f = this._$uP, c = this._$6r, d = this._$3r, g = nt.tr, y = nt._$Ti, m = nt._$Pi, T = nt._$B, P = 0; P < h; P += 3) {
                        ...
                        at.USE_CACHED_POLYGON_IMAGE) {
                            ...
                            at.IGNORE_CLIP || nt.clip(u, g, n, Y, O, D, R, b, F, C, M, E, A, I, x, w),
            ...
            nt.expandClip = function(t, i, e, r, o, n, s, _, a, h) {
                var l = s - o
                  ...
                  , C = h + f * v / L
                  , N = nt._$50;
                return null != i._$P2(N) && (nt.clipWithTransform(t, N, M, E, A, I, x, w, O, D, F, C, R, b),
                !0)
            }
            ,
