...
function showMessage(text, timeout){
    if($.cookie('show-live2d')=='false')return;
...
$(".hide-button").css("display","");
	...
	if($('#landlord').height()!=280 ||$('#landlord').width()!=280){
		$('#landlord').height(280);
		$('#landlord').width(280);
}}

function hideLive2d(){
if($.cookie('show-live2d')=='false'){
	$(".hide-button").css("display","none");
	$(".show-button").css("display","");
	if($('#landlord').height()!=40 ||$('#landlord').width()!=40){
		$('#landlord').height(40);
		$('#landlord').width(40);
}}}

$(".hide-button").bind("click",function(){
    $("#landlord").css("transition","all 1s ease-in-out");
    $("#live2d").css("display","none");
    $('#landlord').height(40);
    $('#landlord').width(40);
    $.cookie('show-live2d',false);
    $(".message").css("display","none");
    $(".hide-button").css("display","none");
    $(".show-button").css("display","");
    loadlive2d("live2d","/l2d/model/null.json");
...
$(".show-button").bind("click",function(){
    $('#landlord').height(280);
    $('#landlord').width(280);
    $("#landlord").css("transition","all 1s cubic-bezier(0.18, 0.89, 0.32, 1.28)");
    $("#live2d").css("display","");
    $.cookie('show-live2d',true);
    $(".message").css("display","");
